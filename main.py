...
from shopping_app.views import (IndexView, AddItemsView, CreateShoppingListView, DashboardView, UpdateShoppingListView,
                                MarkItemView, LoginView, LogoutView, RegisterView, RemoveShoppingListView,
                                UpdateShoppingItemView, ShoppingListDetailView, RemoveShoppingItemView)
...
app.add_url_rule('/remove-shopping-list', view_func=RemoveShoppingListView.as_view('remove-shopping-list'))
app.add_url_rule('/remove-shopping-item', view_func=RemoveShoppingItemView.as_view('remove-shopping-item'))
